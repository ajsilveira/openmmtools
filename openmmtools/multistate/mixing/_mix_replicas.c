...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "openmmtools.multistate.mixing._mix_replicas",
        "sources": [
            "./openmmtools/multistate/mixing/_mix_replicas.pyx"
        ]
    },
    "module_name": "openmmtools.multistate.mixing._mix_replicas"
}
END: Cython Metadata */
...
#define __PYX_HAVE__openmmtools__multistate__mixing___mix_replicas
#define __PYX_HAVE_API__openmmtools__multistate__mixing___mix_replicas
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'openmmtools.multistate.mixing._mix_replicas' */
...
static long __pyx_f_11openmmtools_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(long, long, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "openmmtools.multistate.mixing._mix_replicas"
extern int __pyx_module_is_main_openmmtools__multistate__mixing___mix_replicas;
int __pyx_module_is_main_openmmtools__multistate__mixing___mix_replicas = 0;

/* Implementation of 'openmmtools.multistate.mixing._mix_replicas' */
...
static const char __pyx_k_u_kl[] = "u_kl";
...
static const char __pyx_k_Nij_accepted[] = "Nij_accepted";
static const char __pyx_k_Nij_proposed[] = "Nij_proposed";
static const char __pyx_k_pyx_checksum[] = "__pyx_checksum";
static const char __pyx_k_stringsource[] = "stringsource";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_nswap_attempts[] = "nswap_attempts";
static const char __pyx_k_replica_states[] = "replica_states";
...
static PyObject *__pyx_n_s_Nij_accepted;
static PyObject *__pyx_n_s_Nij_proposed;
...
static PyObject *__pyx_n_s_nswap_attempts;
...
static PyObject *__pyx_n_s_replica_states;
...
static PyObject *__pyx_n_s_u_kl;
static PyObject *__pyx_kp_s_unable_to_allocate_array_data;
static PyObject *__pyx_kp_s_unable_to_allocate_shape_and_str;
static PyObject *__pyx_n_s_unpack;
static PyObject *__pyx_n_s_update;
static PyObject *__pyx_pf_11openmmtools_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_nswap_attempts, long __pyx_v_nstates, __Pyx_memviewslice __pyx_v_replica_states, __Pyx_memviewslice __pyx_v_u_kl, __Pyx_memviewslice __pyx_v_Nij_proposed, __Pyx_memviewslice __pyx_v_Nij_accepted); /* proto */
...
/* "openmmtools/multistate/mixing/_mix_replicas.pyx":10
...
static PyObject *__pyx_pw_11openmmtools_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static long __pyx_f_11openmmtools_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(long __pyx_v_nswap_attempts, long __pyx_v_nstates, __Pyx_memviewslice __pyx_v_replica_states, __Pyx_memviewslice __pyx_v_u_kl, __Pyx_memviewslice __pyx_v_Nij_proposed, __Pyx_memviewslice __pyx_v_Nij_accepted, CYTHON_UNUSED int __pyx_skip_dispatch) {
  CYTHON_UNUSED long __pyx_v_swap_attempt;
  long __pyx_v_i;
  long __pyx_v_j;
  long __pyx_v_istate;
  long __pyx_v_jstate;
  long __pyx_v_tmp_state;
  double __pyx_v_log_P_accept;
  long __pyx_r;
  long __pyx_t_1;
  long __pyx_t_2;
  long __pyx_t_3;
 ...
 */
  __pyx_t_1 = __pyx_v_nswap_attempts;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_swap_attempt = __pyx_t_3;
 ...
 */
    ...
    /* "openmmtools/multistate/mixing/_mix_replicas.pyx":16
 *     for swap_attempt in range(nswap_attempts):
 *         i = <long>(drand48()*nstates)
 *         j = <long>(drand48()*nstates)             # <<<<<<<<<<<<<<
 *         istate = replica_states[i]
 ...
 */
    ...
    /* "openmmtools/multistate/mixing/_mix_replicas.pyx":17
 *         i = <long>(drand48()*nstates)
 *         j = <long>(drand48()*nstates)
 *         istate = replica_states[i]             # <<<<<<<<<<<<<<
 *         jstate = replica_states[j]
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_v_istate = (*((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_4 * __pyx_v_replica_states.strides[0]) )));

    /* "openmmtools/multistate/mixing/_mix_replicas.pyx":18
 *         j = <long>(drand48()*nstates)
 *         istate = replica_states[i]
 *         jstate = replica_states[j]             # <<<<<<<<<<<<<<
 *         if (isnan(u_kl[i, istate]) or isnan(u_kl[i, jstate]) or isnan(u_kl[j, istate]) or isnan(u_kl[j, jstate])):
 ...
 */
    __pyx_t_5 = __pyx_v_j;
    __pyx_v_jstate = (*((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_5 * __pyx_v_replica_states.strides[0]) )));

    /* "openmmtools/multistate/mixing/_mix_replicas.pyx":19
 *         istate = replica_states[i]
 *         jstate = replica_states[j]
 *         if (isnan(u_kl[i, istate]) or isnan(u_kl[i, jstate]) or isnan(u_kl[j, istate]) or isnan(u_kl[j, jstate])):             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    __pyx_t_7 = __pyx_v_i;
    __pyx_t_8 = __pyx_v_istate;
    __pyx_t_9 = (isnan((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u_kl.data + __pyx_t_7 * __pyx_v_u_kl.strides[0]) ) + __pyx_t_8 * __pyx_v_u_kl.strides[1]) )))) != 0);
    if (!__pyx_t_9) {
    } else {
      __pyx_t_6 = __pyx_t_9;
    ...
    __pyx_t_11 = __pyx_v_jstate;
    __pyx_t_9 = (isnan((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u_kl.data + __pyx_t_10 * __pyx_v_u_kl.strides[0]) ) + __pyx_t_11 * __pyx_v_u_kl.strides[1]) )))) != 0);
    if (!__pyx_t_9) {
    } else {
      __pyx_t_6 = __pyx_t_9;
      goto __pyx_L6_bool_binop_done;
    ...
    __pyx_t_13 = __pyx_v_istate;
    __pyx_t_9 = (isnan((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u_kl.data + __pyx_t_12 * __pyx_v_u_kl.strides[0]) ) + __pyx_t_13 * __pyx_v_u_kl.strides[1]) )))) != 0);
    if (!__pyx_t_9) {
    } else {
      __pyx_t_6 = __pyx_t_9;
      goto __pyx_L6_bool_binop_done;
    ...
    __pyx_t_15 = __pyx_v_jstate;
    __pyx_t_9 = (isnan((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u_kl.data + __pyx_t_14 * __pyx_v_u_kl.strides[0]) ) + __pyx_t_15 * __pyx_v_u_kl.strides[1]) )))) != 0);
    __pyx_t_6 = __pyx_t_9;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_6) {

      /* "openmmtools/multistate/mixing/_mix_replicas.pyx":20
 *         jstate = replica_states[j]
 *         if (isnan(u_kl[i, istate]) or isnan(u_kl[i, jstate]) or isnan(u_kl[j, istate]) or isnan(u_kl[j, jstate])):
 *             continue             # <<<<<<<<<<<<<<
 *         log_P_accept = - (u_kl[i, jstate] + u_kl[j, istate]) + (u_kl[j, jstate] + u_kl[i, istate])
 ...
 */
    ...
    /* "openmmtools/multistate/mixing/_mix_replicas.pyx":21
 *         if (isnan(u_kl[i, istate]) or isnan(u_kl[i, jstate]) or isnan(u_kl[j, istate]) or isnan(u_kl[j, jstate])):
 *             continue
 *         log_P_accept = - (u_kl[i, jstate] + u_kl[j, istate]) + (u_kl[j, jstate] + u_kl[i, istate])             # <<<<<<<<<<<<<<
 *         Nij_proposed[istate, jstate] +=1
 ...
 */
    ...
    __pyx_t_17 = __pyx_v_jstate;
    __pyx_t_18 = __pyx_v_j;
    __pyx_t_19 = __pyx_v_istate;
    __pyx_t_20 = __pyx_v_j;
    __pyx_t_21 = __pyx_v_jstate;
    __pyx_t_22 = __pyx_v_i;
    __pyx_t_23 = __pyx_v_istate;
    __pyx_v_log_P_accept = ((-((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u_kl.data + __pyx_t_16 * __pyx_v_u_kl.strides[0]) ) + __pyx_t_17 * __pyx_v_u_kl.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u_kl.data + __pyx_t_18 * __pyx_v_u_kl.strides[0]) ) + __pyx_t_19 * __pyx_v_u_kl.strides[1]) ))))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u_kl.data + __pyx_t_20 * __pyx_v_u_kl.strides[0]) ) + __pyx_t_21 * __pyx_v_u_kl.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u_kl.data + __pyx_t_22 * __pyx_v_u_kl.strides[0]) ) + __pyx_t_23 * __pyx_v_u_kl.strides[1]) )))));

    /* "openmmtools/multistate/mixing/_mix_replicas.pyx":22
 *             continue
 *         log_P_accept = - (u_kl[i, jstate] + u_kl[j, istate]) + (u_kl[j, jstate] + u_kl[i, istate])
 *         Nij_proposed[istate, jstate] +=1             # <<<<<<<<<<<<<<
 *         Nij_proposed[jstate, istate] +=1
 ...
 */
    __pyx_t_24 = __pyx_v_istate;
    __pyx_t_25 = __pyx_v_jstate;
    *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Nij_proposed.data + __pyx_t_24 * __pyx_v_Nij_proposed.strides[0]) ) + __pyx_t_25 * __pyx_v_Nij_proposed.strides[1]) )) += 1;

    /* "openmmtools/multistate/mixing/_mix_replicas.pyx":23
 *         log_P_accept = - (u_kl[i, jstate] + u_kl[j, istate]) + (u_kl[j, jstate] + u_kl[i, istate])
 *         Nij_proposed[istate, jstate] +=1
 *         Nij_proposed[jstate, istate] +=1             # <<<<<<<<<<<<<<
 *         if(log_P_accept>=0 or drand48()<exp(log_P_accept)):
 ...
 */
    __pyx_t_26 = __pyx_v_jstate;
    __pyx_t_27 = __pyx_v_istate;
    *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Nij_proposed.data + __pyx_t_26 * __pyx_v_Nij_proposed.strides[0]) ) + __pyx_t_27 * __pyx_v_Nij_proposed.strides[1]) )) += 1;

    /* "openmmtools/multistate/mixing/_mix_replicas.pyx":24
 *         Nij_proposed[istate, jstate] +=1
 *         Nij_proposed[jstate, istate] +=1
 *         if(log_P_accept>=0 or drand48()<exp(log_P_accept)):             # <<<<<<<<<<<<<<
 *             tmp_state = replica_states[i]
 ...
 */
    __pyx_t_9 = ((__pyx_v_log_P_accept >= 0.0) != 0);
    if (!__pyx_t_9) {
    } else {
      __pyx_t_6 = __pyx_t_9;
      goto __pyx_L11_bool_binop_done;
    }
    __pyx_t_9 = ((drand48() < exp(__pyx_v_log_P_accept)) != 0);
    __pyx_t_6 = __pyx_t_9;
    __pyx_L11_bool_binop_done:;
    if (__pyx_t_6) {

      /* "openmmtools/multistate/mixing/_mix_replicas.pyx":25
 *         Nij_proposed[jstate, istate] +=1
 *         if(log_P_accept>=0 or drand48()<exp(log_P_accept)):
 *             tmp_state = replica_states[i]             # <<<<<<<<<<<<<<
 *             replica_states[i] = replica_states[j]
 ...
 */
      ...
      __pyx_v_tmp_state = (*((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_28 * __pyx_v_replica_states.strides[0]) )));

      /* "openmmtools/multistate/mixing/_mix_replicas.pyx":26
 *         if(log_P_accept>=0 or drand48()<exp(log_P_accept)):
 *             tmp_state = replica_states[i]
 *             replica_states[i] = replica_states[j]             # <<<<<<<<<<<<<<
 *             replica_states[j] = tmp_state
 ...
 */
      ...
      *((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_30 * __pyx_v_replica_states.strides[0]) )) = (*((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_29 * __pyx_v_replica_states.strides[0]) )));

      /* "openmmtools/multistate/mixing/_mix_replicas.pyx":27
 *             tmp_state = replica_states[i]
 *             replica_states[i] = replica_states[j]
 *             replica_states[j] = tmp_state             # <<<<<<<<<<<<<<
 *             Nij_accepted[istate,jstate] += 1
 ...
 */
      ...
      *((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_31 * __pyx_v_replica_states.strides[0]) )) = __pyx_v_tmp_state;

      /* "openmmtools/multistate/mixing/_mix_replicas.pyx":28
 *             replica_states[i] = replica_states[j]
 *             replica_states[j] = tmp_state
 *             Nij_accepted[istate,jstate] += 1             # <<<<<<<<<<<<<<
 *             Nij_accepted[jstate,istate] += 1
 *     return 0
 */
      __pyx_t_32 = __pyx_v_istate;
      __pyx_t_33 = __pyx_v_jstate;
      *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Nij_accepted.data + __pyx_t_32 * __pyx_v_Nij_accepted.strides[0]) ) + __pyx_t_33 * __pyx_v_Nij_accepted.strides[1]) )) += 1;

      /* "openmmtools/multistate/mixing/_mix_replicas.pyx":29
 *             replica_states[j] = tmp_state
 *             Nij_accepted[istate,jstate] += 1
 *             Nij_accepted[jstate,istate] += 1             # <<<<<<<<<<<<<<
 *     return 0
 * 
 */
      __pyx_t_34 = __pyx_v_jstate;
      __pyx_t_35 = __pyx_v_istate;
      *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Nij_accepted.data + __pyx_t_34 * __pyx_v_Nij_accepted.strides[0]) ) + __pyx_t_35 * __pyx_v_Nij_accepted.strides[1]) )) += 1;
 ...
 */
  ...
  /* "openmmtools/multistate/mixing/_mix_replicas.pyx":30
 *             Nij_accepted[istate,jstate] += 1
 *             Nij_accepted[jstate,istate] += 1
 *     return 0             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_11openmmtools_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11openmmtools_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  long __pyx_v_nswap_attempts;
  long __pyx_v_nstates;
  __Pyx_memviewslice __pyx_v_replica_states = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_u_kl = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_Nij_proposed = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_Nij_accepted = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_mix_replicas_cython (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_nswap_attempts,&__pyx_n_s_nstates,&__pyx_n_s_replica_states,&__pyx_n_s_u_kl,&__pyx_n_s_Nij_proposed,&__pyx_n_s_Nij_accepted,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nswap_attempts)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nstates)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mix_replicas_cython", 1, 6, 6, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_replica_states)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mix_replicas_cython", 1, 6, 6, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_u_kl)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mix_replicas_cython", 1, 6, 6, 3); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Nij_proposed)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mix_replicas_cython", 1, 6, 6, 4); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Nij_accepted)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mix_replicas_cython", 1, 6, 6, 5); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_mix_replicas_cython") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_nswap_attempts = __Pyx_PyInt_As_long(values[0]); if (unlikely((__pyx_v_nswap_attempts == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_nstates = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_nstates == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_replica_states = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_replica_states.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_u_kl = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_u_kl.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_Nij_proposed = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_Nij_proposed.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_Nij_accepted = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_Nij_accepted.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_mix_replicas_cython", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("openmmtools.multistate.mixing._mix_replicas._mix_replicas_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11openmmtools_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(__pyx_self, __pyx_v_nswap_attempts, __pyx_v_nstates, __pyx_v_replica_states, __pyx_v_u_kl, __pyx_v_Nij_proposed, __pyx_v_Nij_accepted);
...
static PyObject *__pyx_pf_11openmmtools_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_nswap_attempts, long __pyx_v_nstates, __Pyx_memviewslice __pyx_v_replica_states, __Pyx_memviewslice __pyx_v_u_kl, __Pyx_memviewslice __pyx_v_Nij_proposed, __Pyx_memviewslice __pyx_v_Nij_accepted) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("_mix_replicas_cython", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_replica_states.memview)) { __Pyx_RaiseUnboundLocalError("replica_states"); __PYX_ERR(0, 10, __pyx_L1_error) }
  if (unlikely(!__pyx_v_u_kl.memview)) { __Pyx_RaiseUnboundLocalError("u_kl"); __PYX_ERR(0, 10, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Nij_proposed.memview)) { __Pyx_RaiseUnboundLocalError("Nij_proposed"); __PYX_ERR(0, 10, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Nij_accepted.memview)) { __Pyx_RaiseUnboundLocalError("Nij_accepted"); __PYX_ERR(0, 10, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_11openmmtools_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(__pyx_v_nswap_attempts, __pyx_v_nstates, __pyx_v_replica_states, __pyx_v_u_kl, __pyx_v_Nij_proposed, __pyx_v_Nij_accepted, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_replica_states, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_u_kl, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_Nij_proposed, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_Nij_accepted, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "openmmtools.multistate.mixing._mix_replicas.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "openmmtools.multistate.mixing._mix_replicas.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "openmmtools.multistate.mixing._mix_replicas.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "openmmtools.multistate.mixing._mix_replicas._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"_mix_replicas_cython", (PyCFunction)__pyx_pw_11openmmtools_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__mix_replicas(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__mix_replicas},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_Nij_accepted, __pyx_k_Nij_accepted, sizeof(__pyx_k_Nij_accepted), 0, 0, 1, 1},
  {&__pyx_n_s_Nij_proposed, __pyx_k_Nij_proposed, sizeof(__pyx_k_Nij_proposed), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_nswap_attempts, __pyx_k_nswap_attempts, sizeof(__pyx_k_nswap_attempts), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_replica_states, __pyx_k_replica_states, sizeof(__pyx_k_replica_states), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_u_kl, __pyx_k_u_kl, sizeof(__pyx_k_u_kl), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_mix_replicas(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_mix_replicas(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__mix_replicas(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__mix_replicas(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec__mix_replicas(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__mix_replicas(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_mix_replicas", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_openmmtools__multistate__mixing___mix_replicas) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "openmmtools.multistate.mixing._mix_replicas")) {
      if (unlikely(PyDict_SetItemString(modules, "openmmtools.multistate.mixing._mix_replicas", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "openmmtools/multistate/mixing/_mix_replicas.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init openmmtools.multistate.mixing._mix_replicas", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init openmmtools.multistate.mixing._mix_replicas");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
