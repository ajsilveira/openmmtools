...
class MultiStateSampler(object):
    ...
    def _compute_replica_energies(self, replica_id):
        ...
        for energies, thermo_states in [(energy_neighborhood_states, neighborhood_thermodynamic_states),
                                 (energy_unsampled_states, self._unsampled_states)]:
            # Group thermodynamic states by compatibility.
            compatible_groups, original_indices = states.group_by_compatibility(thermo_states)
