...
#            ncfile.ConventionVersion = '0.2'
    ...
    def read_mcmc_moves(self):
        """Return the MCMCMoves of the :class:`openmmtools.multistate.MultiStateSampler` simulation on the checkpoint
    ...
    def write_mcmc_moves(self, mcmc_moves):
        """Store the MCMCMoves of the :class:`openmmtools.multistate.MultiStateSampler` simulation or subclasses on the checkpoint
    ...
    def read_dict(self, path: str) -> Union[dict, Any]:
        ...
        >>> import os
        >>> data = {'info': [1, 2, 3]}
        >>> with utils.temporary_directory() as temp_dir_path:
